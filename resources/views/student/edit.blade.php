...
<div class="container">
    <h2>Update Student</h2>
        <ul class="nav nav-tabs" id="studentTab" role="tablist">
            ...
            <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#siblings" type="button" role="tab">Siblings</button></li>
        ...
        <div class="tab-content mt-3" id="studentTabContent">
            ...
            <div class="tab-pane fade" id="siblings" role="tabpanel">@include('student.tabs.siblings')</div>
